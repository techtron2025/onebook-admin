    ...
    <div ref="content" class="box">
        ...
        <div class="list-title" ref="listTitle">
            <div style="width: 300px">
                <el-input style="width: 100%" v-model="form.keywords" placeholder="请输入姓名查询" clearable></el-input>
            </div>
            <div class="f-ml-10">
        ...
        <div class="table-content" ref="container">
            ...
            >
                ...
                <el-table-column prop="name" label="树洞名称" width="160"></el-table-column>
                <el-table-column prop="email" label="邮箱" width="200"></el-table-column>

                <el-table-column prop="status" label="状态" width="130">
                    <template #default="{row}">
                        <div>
                            <el-switch v-model="row.status" :active-value="1" :inactive-value="2" @change="change(row.id)" />
                        </div>
                    </template>
                </el-table-column>
                <el-table-column prop="content" label="留言" min-width="160"></el-table-column>
                <el-table-column prop="createTime" label="创建时间" width="200"></el-table-column>
                <el-table-column label="操作" width="100" fixed="right">
                    <template #default="{row}">
                        <el-popconfirm title="确定要删除该树洞吗?" @confirm="delHandle(row.id)">
                            <template #reference>
