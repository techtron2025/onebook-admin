...
export default {
    ...
    articleList(params, loading, headers) {
        return _http('post', {url: '/api/blog/query', apiName: '博文列表'}, params, loading, headers)
    },
    articleAdd(params, loading, headers) {
        return _http('post', {url: '/api/admin/article/add', apiName: '新增博文'}, params, loading, headers)
    },
    ...
    articleDetail(params, loading, headers) {
        return _http('post', {url: '/api/admin/article/detail', apiName: '博文详情'}, params, loading, headers)
    },
    articleDel(params, loading, headers) {
        return _http('post', {url: '/api/admin/article/del', apiName: '删除博文'}, params, loading, headers)
    },
