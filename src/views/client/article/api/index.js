...
export default {
    ...
    articleList(params, loading, headers) {
        return _http('post', {url: '/api/blog/list', apiName: '博文列表'}, params, loading, headers)
    },
    articleAdd(params, loading, headers) {
        return _http('post', {url: '/api/blog/add', apiName: '新增博文'}, params, loading, headers)
    },
    ...
    articleDetail(params, loading, headers) {
        return _http('post', {url: '/api/blog/detail', apiName: '博文详情'}, params, loading, headers)
    },
    articleDel(params, loading, headers) {
        return _http('post', {url: '/api/blog/delete', apiName: '删除博文'}, params, loading, headers)
    },
